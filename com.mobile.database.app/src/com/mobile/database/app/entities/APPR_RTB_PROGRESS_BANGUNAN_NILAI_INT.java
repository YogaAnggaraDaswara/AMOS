...
public class APPR_RTB_PROGRESS_BANGUNAN_NILAI_INT {
	@DatabaseField(id=true,unique=true,canBeNull=false,uniqueIndexName="APPR_INBOXS_PK",dataType=DataType.STRING) private String AP_REGNO;
	@DatabaseField(dataType=DataType.STRING,width=20) private String ALT_TYPE;
	@DatabaseField(dataType=DataType.STRING,width=40) private String ALT_ID;
