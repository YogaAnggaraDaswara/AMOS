...
public class Debitur_DocumentActivity extends Activity{
	private Context ctx;
	...
	public Debitur_DocumentActivity() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.amos_document_status);
		
		val_txt_nama = (EditText) findViewById(R.id.val_txt_nama);
		val_tgl_lhr = (EditText) findViewById(R.id.val_tgl_lhr);
...
//			new loadProspekData().execute(); 
  	...
  	public void BackActivity() {
    	Intent i = new Intent(Debitur_DocumentActivity.this, HomeActivity.class);   
    	startActivity(i);
    	finish();
  	}
	...
	private void initControl()
	{
		...
		view_img_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
	                if (!val_tgl_lhr.getText().toString().equalsIgnoreCase("")) {
	                    arrTglLahir = val_tgl_lhr.getText().toString().split("-");
	...
	private DatePickerDialog.OnDateSetListener PbTglLahirDebSetListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker arg0, int year, int monthOfYear, int dayOfMonth) {
        	val_tgl_lhr.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
        }
    };
