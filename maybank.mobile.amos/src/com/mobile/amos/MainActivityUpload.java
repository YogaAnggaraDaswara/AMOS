...
public class MainActivityUpload extends Activity {
    ...
    private Upload_JaminanActivity jaminan =new Upload_JaminanActivity();
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  mDrawerList.setAdapter(new ArrayAdapter<String>(this,
        ...
        getActionBar().setTitle(R.string.lbl_upload_doc);
...
//    	if (selectedItem.compareTo("Main") == 0) {
           // fragment = new Upload_JaminanActivity();
//    	}
    	if(!apregno.equals("")){
	    	 Bundle b = new Bundle();
	         b.putString("AP_REGNO", apregno);
