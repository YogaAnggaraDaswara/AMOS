 ...
 * {@link FlipAnimation}. Furthermore, utility methods are provided for
 * initiating fade-in-then-out and flip animations.
 * 
...
public class AnimationFactory {
	...
	public static Animation[] flipAnimation(final View fromView,
		...
		Animation outFlip = new FlipAnimation(dir.getStartDegreeForFirstView(),
				dir.getEndDegreeForFirstView(), centerX, centerY,
		...
		Animation inFlip = new FlipAnimation(dir.getStartDegreeForSecondView(),
				dir.getEndDegreeForSecondView(), centerX, centerY,
				FlipAnimation.SCALE_DEFAULT,
	...
	/**
	 * Flip to the next view of the {@code ViewAnimator}'s subviews. A call to
	 * this method will initiate a {@link FlipAnimation} to show the next View.
	 * If the currently visible view is the last view, flip direction will be
	 * reversed for this transition.
	 * 
	 * @param viewAnimator
	 *            the {@code ViewAnimator}
	 * @param dir
	...
	public static Animation[] createFlipTransition(final ViewAnimator viewAnimator, FlipDirection dir) {
		final View fromView = viewAnimator.getCurrentView();
		final int currentIndex = viewAnimator.getDisplayedChild();
		final int nextIndex = (currentIndex + 1) % viewAnimator.getChildCount();
	 ...
	 *            the animation duration in milliseconds
	 * @param delay
	 *            how long to wait after fading in the subject and before
	 ...
	 * 
	 * @param v
	 *            the view to be faded in then out
	 * @param delay
	 *            how long the view will be visible for
	 */
